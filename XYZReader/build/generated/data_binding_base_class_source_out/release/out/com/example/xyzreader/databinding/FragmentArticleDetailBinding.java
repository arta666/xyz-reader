...
public final class FragmentArticleDetailBinding implements ViewBinding {
  ...
  private FragmentArticleDetailBinding(@NonNull CoordinatorLayout rootView,
      @NonNull AppBarLayout appbar, @NonNull TextView articleBody, @NonNull TextView articleByline,
      @NonNull TextView articleTitle, @NonNull Toolbar detailToolbar,
      @NonNull LinearLayout detailsTextContainer, @NonNull CoordinatorLayout drawInsetsFrameLayout,
      @NonNull LinearLayout metaBar, @NonNull FrameLayout photoContainer,
      @NonNull NestedScrollView scrollView, @NonNull FloatingActionButton shareFab,
      @NonNull ImageView thumbnail, @NonNull CollapsingToolbarLayout toolbar) {
  ...
  public static FragmentArticleDetailBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.details_text_container;
      LinearLayout detailsTextContainer = rootView.findViewById(id);
      if (detailsTextContainer == null) {
        break missingId;
      }
      ...
      return new FragmentArticleDetailBinding((CoordinatorLayout) rootView, appbar, articleBody,
          ...
          metaBar, photoContainer, scrollView, shareFab, thumbnail, toolbar);
    }
